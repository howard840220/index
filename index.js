...
(lib._1204檔案 = function(mode,startPosition,loop) {
	...
	this.frame_1255 = function() {
		...
		*/
		...
		this.sp4.addEventListener("click", fl_ClickToGoToAndStopAtFrame_16.bind(this));
	...
	this.frame_1257 = function() {
		...
		*/
		...
		this.gp.addEventListener("click", fl_ClickToGoToAndStopAtFrame_17.bind(this));
		...
		*/
		...
		this.bt.addEventListener("click", fl_ClickToGoToAndStopAtFrame_19.bind(this));
	...
	this.frame_1259 = function() {
		...
		*/
		...
		this.gp.addEventListener("click", fl_ClickToGoToAndStopAtFrame_20.bind(this));
		...
		*/
		...
		this.bt.addEventListener("click", fl_ClickToGoToAndStopAtFrame_21.bind(this));
	...
	this.frame_1261 = function() {
		...
		*/
		...
		this.gp.addEventListener("click", fl_ClickToGoToAndStopAtFrame_22.bind(this));
		...
		*/
		...
		this.bt.addEventListener("click", fl_ClickToGoToAndStopAtFrame_23.bind(this));
	...
	this.frame_1263 = function() {
		...
		*/
		...
		this.gp.addEventListener("click", fl_ClickToGoToAndStopAtFrame_24.bind(this));
		...
		*/
		...
		this.bt.addEventListener("click", fl_ClickToGoToAndStopAtFrame_25.bind(this));
	...
	this.frame_1265 = function() {
		...
		*/
		...
		this.bt.addEventListener("click", fl_ClickToGoToAndStopAtFrame_26.bind(this));
		...
		*/
		...
		this.gp.addEventListener("click", fl_ClickToGoToAndStopAtFrame_27.bind(this));
	...
	this.frame_1267 = function() {
		...
		*/
		...
		this.bt.addEventListener("click", fl_ClickToGoToAndStopAtFrame_28.bind(this));
		...
		*/
		...
		this.gp.addEventListener("click", fl_ClickToGoToAndStopAtFrame_29.bind(this));
	...
	this.frame_1269 = function() {
		...
		*/
		...
		this.bt.addEventListener("click", fl_ClickToGoToAndStopAtFrame_30.bind(this));
		...
		*/
		...
		this.gp.addEventListener("click", fl_ClickToGoToAndStopAtFrame_31.bind(this));
	...
	this.frame_1271 = function() {
		...
		*/
		...
		this.gp.addEventListener("click", fl_ClickToGoToAndStopAtFrame_32.bind(this));
		...
		*/
		...
		this.bt.addEventListener("click", fl_ClickToGoToAndStopAtFrame_33.bind(this));
	...
	this.frame_1273 = function() {
		...
		*/
		...
		this.gp.addEventListener("click", fl_ClickToGoToAndStopAtFrame_34.bind(this));
		...
		*/
		...
		this.bt.addEventListener("click", fl_ClickToGoToAndStopAtFrame_35.bind(this));
	...
	this.frame_1275 = function() {
		...
		*/
		...
		this.gp.addEventListener("click", fl_ClickToGoToAndStopAtFrame_36.bind(this));
		...
		*/
		...
		this.bt.addEventListener("click", fl_ClickToGoToAndStopAtFrame_37.bind(this));
	...
	this.frame_1277 = function() {
		...
		*/
		...
		this.gp.addEventListener("click", fl_ClickToGoToAndStopAtFrame_38.bind(this));
		...
		*/
		...
		this.bt.addEventListener("click", fl_ClickToGoToAndStopAtFrame_39.bind(this));
	...
	this.frame_1280 = function() {
		...
		*/
		...
		this.bt.addEventListener("click", fl_ClickToGoToAndStopAtFrame_41.bind(this));
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(224).call(this.frame_224).wait(1009).call(this.frame_1233).wait(22).call(this.frame_1255).wait(2).call(this.frame_1257).wait(2).call(this.frame_1259).wait(2).call(this.frame_1261).wait(2).call(this.frame_1263).wait(2).call(this.frame_1265).wait(2).call(this.frame_1267).wait(2).call(this.frame_1269).wait(2).call(this.frame_1271).wait(2).call(this.frame_1273).wait(2).call(this.frame_1275).wait(2).call(this.frame_1277).wait(3).call(this.frame_1280).wait(1161));
	...
	this.bt.setTransform(43.2,425.2,1,1,0,0,180,25.9,118.5);
	new cjs.ButtonHelper(this.bt, 0, 1, 1);

	this.gp = new lib.元件37();
	this.gp.setTransform(1264,425.2,1,1,0,0,0,25.9,118.5);
	new cjs.ButtonHelper(this.gp, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.gp},{t:this.bt}]},1257).to({state:[{t:this.gp},{t:this.bt}]},2).to({state:[{t:this.gp},{t:this.bt}]},2).to({state:[{t:this.gp},{t:this.bt}]},2).to({state:[{t:this.gp},{t:this.bt}]},2).to({state:[{t:this.gp},{t:this.bt}]},2).to({state:[{t:this.gp},{t:this.bt}]},2).to({state:[{t:this.gp},{t:this.bt}]},2).to({state:[{t:this.gp},{t:this.bt}]},2).to({state:[{t:this.gp},{t:this.bt}]},2).to({state:[{t:this.gp},{t:this.bt}]},2).to({state:[{t:this.bt}]},3).to({state:[]},1).wait(1160));
	...
	this.instance_21 = new lib.元件38();
	this.instance_21.setTransform(1065.2,543.5,1,1,0,0,0,113.1,113.1);
	new cjs.ButtonHelper(this.instance_21, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1},{t:this.instance}]},1256).to({state:[{t:this.instance_3},{t:this.instance_2}]},2).to({state:[{t:this.instance_5},{t:this.instance_4}]},2).to({state:[{t:this.instance_7},{t:this.instance_6}]},2).to({state:[{t:this.instance_9},{t:this.instance_8}]},2).to({state:[{t:this.instance_11},{t:this.instance_10}]},2).to({state:[{t:this.instance_13},{t:this.instance_12}]},2).to({state:[{t:this.instance_15},{t:this.instance_14}]},2).to({state:[{t:this.instance_16}]},2).to({state:[{t:this.instance_18},{t:this.instance_17}]},2).to({state:[{t:this.instance_20},{t:this.instance_19}]},2).to({state:[{t:this.instance_21}]},2).to({state:[]},3).wait(1160));
