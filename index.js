...
(lib._1204檔案修正 = function(mode,startPosition,loop) {
	...
	this.drews.setTransform(22.4,306);
	new cjs.ButtonHelper(this.drews, 0, 1, 1);

	this.instance = new lib.元件38();
	this.instance.setTransform(1065.2,543.5,1,1,0,0,0,113.1,113.1);
	...
	this.lkiujhnbgvdfrgsrgr.setTransform(22.4,306);
	new cjs.ButtonHelper(this.lkiujhnbgvdfrgsrgr, 0, 1, 1);

	this.hghghrtjrjuher = new lib.測試啦();
	this.hghghrtjrjuher.setTransform(1263.2,424.5,1,1,0,0,0,25.9,118.5);
	new cjs.ButtonHelper(this.hghghrtjrjuher, 0, 1, 1);

	this.instance_1 = new lib._12420161R();
	this.instance_1.setTransform(645.6,147.1,0.896,0.896);

	this.instance_2 = new lib._12420161L();
	this.instance_2.setTransform(118.5,169.3,0.879,0.879);
	...
	this.bvbvbvbvbfgre.setTransform(22.4,306);
	new cjs.ButtonHelper(this.bvbvbvbvbfgre, 0, 1, 1);

	this.dhtrdbvsdvcdfdgw = new lib.測試啦();
	this.dhtrdbvsdvcdfdgw.setTransform(1263.2,424.5,1,1,0,0,0,25.9,118.5);
	new cjs.ButtonHelper(this.dhtrdbvsdvcdfdgw, 0, 1, 1);

	this.instance_3 = new lib._12420151R();
	this.instance_3.setTransform(670,183,0.854,0.854);

	this.instance_4 = new lib._12420151L();
	this.instance_4.setTransform(107.1,143.9,0.925,0.925);
	...
	this.fewsdcv.setTransform(22.4,306);
	new cjs.ButtonHelper(this.fewsdcv, 0, 1, 1);

	this.kijuyhngbf = new lib.測試啦();
	this.kijuyhngbf.setTransform(1263.2,424.5,1,1,0,0,0,25.9,118.5);
	new cjs.ButtonHelper(this.kijuyhngbf, 0, 1, 1);

	this.instance_5 = new lib._12420142L();
	this.instance_5.setTransform(136.5,180.9,0.858,0.858);
	...
	this.liukyjhntgbfdv.setTransform(22.4,306);
	new cjs.ButtonHelper(this.liukyjhntgbfdv, 0, 1, 1);

	this.grewvfsagthytetrutegbr = new lib.測試啦();
	this.grewvfsagthytetrutegbr.setTransform(1263.2,424.5,1,1,0,0,0,25.9,118.5);
	new cjs.ButtonHelper(this.grewvfsagthytetrutegbr, 0, 1, 1);

	this.instance_6 = new lib._12420141R();
	this.instance_6.setTransform(636.1,151,0.929,0.929);

	this.instance_7 = new lib._12420141L();
	this.instance_7.setTransform(128.4,151,0.908,0.908);
	...
	this.jutyngf.setTransform(22.4,306);
	new cjs.ButtonHelper(this.jutyngf, 0, 1, 1);

	this.sgfdgdsfgs = new lib.測試啦();
	this.sgfdgdsfgs.setTransform(1263.2,424.5,1,1,0,0,0,25.9,118.5);
	new cjs.ButtonHelper(this.sgfdgdsfgs, 0, 1, 1);

	this.instance_8 = new lib._12420132R();
	this.instance_8.setTransform(638.6,145.6,0.942,0.942);

	this.instance_9 = new lib._12420132L();
	this.instance_9.setTransform(113.6,151.6,0.92,0.92);
	...
	this.frd.setTransform(22.4,306);
	new cjs.ButtonHelper(this.frd, 0, 1, 1);

	this.jkjk = new lib.測試啦();
	this.jkjk.setTransform(1263.2,424.5,1,1,0,0,0,25.9,118.5);
	...
	this.sasa.setTransform(22.4,306);
	new cjs.ButtonHelper(this.sasa, 0, 1, 1);

	this.gfgfg = new lib.測試啦();
	this.gfgfg.setTransform(1263.2,424.5,1,1,0,0,0,25.9,118.5);
	new cjs.ButtonHelper(this.gfgfg, 0, 1, 1);

	this.instance_12 = new lib._12420121R();
	this.instance_12.setTransform(662.2,169.9,0.875,0.875);

	this.instance_13 = new lib._12420121L();
	this.instance_13.setTransform(115,169.9,0.903,0.903);
	...
	this.sisi.setTransform(22.4,306);
	new cjs.ButtonHelper(this.sisi, 0, 1, 1);

	this.haha = new lib.測試啦();
	this.haha.setTransform(1263.2,424.5,1,1,0,0,0,25.9,118.5);
	new cjs.ButtonHelper(this.haha, 0, 1, 1);

	this.instance_14 = new lib._12420112R();
	this.instance_14.setTransform(661.9,172.1,0.895,0.895);

	this.instance_15 = new lib._12420112L();
	this.instance_15.setTransform(111,162.1,0.9,0.9);
	...
	this.bt2.setTransform(22.4,306);
	new cjs.ButtonHelper(this.bt2, 0, 1, 1);

	this.gp2 = new lib.測試啦();
	this.gp2.setTransform(1263.2,424.5,1,1,0,0,0,25.9,118.5);
	new cjs.ButtonHelper(this.gp2, 0, 1, 1);

	this.instance_16 = new lib._12420111R();
	this.instance_16.setTransform(654.3,166.7,0.916,0.916);

	this.instance_17 = new lib._12420111L();
	this.instance_17.setTransform(100.6,148.3,0.95,0.95);
	...
	this.qwe.setTransform(22.4,306);
	new cjs.ButtonHelper(this.qwe, 0, 1, 1);

	this.asd = new lib.測試啦();
	this.asd.setTransform(1263.2,424.5,1,1,0,0,0,25.9,118.5);
	new cjs.ButtonHelper(this.asd, 0, 1, 1);

	this.instance_18 = new lib._12420101R();
	this.instance_18.setTransform(659.1,173.9,0.866,0.866);

	this.instance_19 = new lib._12420092L();
	this.instance_19.setTransform(123.1,171.4,0.856,0.856);
	...
	this.bt1.setTransform(22.6,306);
	new cjs.ButtonHelper(this.bt1, 0, 1, 1);

	this.gp1 = new lib.測試啦();
	this.gp1.setTransform(1263.4,424.5,1,1,0,0,0,25.9,118.5);
	new cjs.ButtonHelper(this.gp1, 0, 1, 1);

	this.instance_20 = new lib._12420091Rpng複製();
	this.instance_20.setTransform(659.6,167.2,0.872,0.872);

	this.instance_21 = new lib._12420091Lpng複製();
	this.instance_21.setTransform(106.6,157.2,0.922,0.922);
